...
function Jewelries() {
  let {jewelries,addJewelry} = useJewelries()
  
  const columns = createColumnsFromData(jewelries, {
    excludeColumns: ['id'],
    columnSizes: {
      name: 200,
      quantity: 150,
  ...
  const handleAddGold = () => {
    const newGold = {
      id: jewelries.length + 1,
      name: `commodity Item ${jewelries.length + 1}`,
      price: 5000,
      quantity:2,
      description:400,
    }
  ...
  return (
    <DataTable
      ...
      enableSorting={true}
      idKey="id"
      tableTitle="jewelries Inventory"
